;;;; runtime/font-table.lisp --- The glyph table.  GENERATED, WHOLLY.
;;;;
;;;; Do not edit this file.  tools/psf-to-lisp.py writes it and nothing else,
;;;; and the four functions that used to live at the bottom of it are in
;;;; runtime/font.lisp, which is ordinary source.  They were inside a Python
;;;; string literal -- CURRENT-FONT, GLYPH-ROW, TEXT-WIDTH and TEXT-HEIGHT,
;;;; four functions of the running program held in a generator that is run by
;;;; hand once a year, where no editor indents them, no compiler sees them
;;;; until they are pasted out, and changing one means editing a string.
;;;;
