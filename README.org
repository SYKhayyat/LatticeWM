...
Working, and used. Not yet announced. Multi-monitor and a few protocol corners
have been exercised nested but not on bare metal — see [[file:PLAN.org::#log2][PLAN.org §log2]] for the
current list of what is verified and what is merely written.
